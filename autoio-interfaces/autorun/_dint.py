...
def optimized_geom(script_str, run_dir,
    ...
    input_str = dint_io.parser.inputi_file(geo)
#    aux_dct = {
#        'basis.dat': basis_str,
#        'coef.dat': coef_str
...
#    }
    ...
    # Parse out the info
    opt_geo = dint_io.parser.geo(output_strs[0])
    rot_consts = dint_io.parser.geo(output_strs[0])
    energy = dint_io.parser.geo(output_strs[0])
